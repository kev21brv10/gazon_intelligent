...
def compute_decision(
    ...
    return DecisionResult(
        ...
        extra={
            ...
            "watering_window_optimal_start_minute": risk_bundle.get(
                "watering_window_optimal_start_minute"
            ),
            "watering_window_optimal_end_minute": risk_bundle.get(
                "watering_window_optimal_end_minute"
            ),
            "watering_window_acceptable_end_minute": risk_bundle.get(
...
def build_decision_snapshot(
    ...
    result = DecisionResult(
        ...
        extra={
            ...
            "reserve_utile_mm": water_bundle["water_balance"].get("reserve_utile_mm"),
            "reserve_stock_mm": water_bundle["water_balance"].get("reserve_stock_mm"),
            "reserve_stock_max_mm": water_bundle["water_balance"].get("reserve_stock_max_mm"),
            "reserve_surplus_mm": water_bundle["water_balance"].get("reserve_surplus_mm"),
            "reserve_actuelle_mm": water_bundle["water_balance"].get("reserve_actuelle_mm"),
            "reserve_fill_ratio": water_bundle["water_balance"].get("reserve_fill_ratio"),
            "reserve_available_ratio": water_bundle["water_balance"].get("reserve_available_ratio"),
            "mad_ratio": water_bundle["water_balance"].get("mad_ratio"),
            "depletion_allowed_mm": water_bundle["water_balance"].get("depletion_allowed_mm"),
            "reserve_minimale_mm": water_bundle["water_balance"].get("reserve_minimale_mm"),
            "depletion_mm": water_bundle["water_balance"].get("depletion_mm"),
            "depletion_ratio": water_bundle["water_balance"].get("depletion_ratio"),
            "watering_target_date": watering_target_date,
            "next_action_date": watering_target_date,
            "next_action_display": next_action_display,
            "raison_blocage_tonte": reason_blocage_tonte,
            ...
            "objectif_mm_brut": water_bundle["objectif_mm_brut"],
            "deficit_brut_mm": watering_bundle.get("deficit_brut_mm"),
            "mm_cible": watering_bundle.get("mm_cible"),
            "mm_final_recommande": watering_bundle.get("mm_final_recommande"),
            "mm_final": watering_bundle.get("mm_final"),
